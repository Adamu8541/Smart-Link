...
export class MonnifyService {
  ...
  /**
   * Reads Monnify configuration safely from environment variables
   */
  ...
  private async loginToMonnify(isRefresh: boolean = false): Promise<string> {
    ...
    if (!config.isConfigured) {
      ...
      console.warn("[MonnifyService] MONNIFY_API_KEY or MONNIFY_SECRET_KEY is missing in environment variables. Using sandbox mock auth mode.");
