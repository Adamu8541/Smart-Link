...
export const NIN_SLIP_OPTIONS: SlipOptionConfig[] = [
  {
    ...
    price: 180,
    description: "Official NIN Slip format with demographic fields, barcode, and QR verification.",
    dimensions: "A4 / Letter (Portrait)",
    recommendedFor: "General Identity Verification & Official Enrolment Confirmation",
    themeColor: "#10b981",
  ...
  },
  {
    ...
    badgeColor: "bg-[#F5F7FA] text-[#0F2D5C] border border-[#E5E7EB]",
    price: 250,
    description: "Standard plastic wallet identity card layout with dual-sided print formatting.",
    dimensions: "CR80 Plastic Card Size",
    recommendedFor: "Plastic Card Printing & Wallet ID",
    themeColor: "#0F2D5C",
    bgGradient: "from-[#0F2D5C]/10 via-[#0F2D5C]/5 to-[#111827]/10",
    features: [
      "Front & Back ID Layout",
      "Biometric Photograph",
      "Official Tracking Number & QR Code",
    ],
    isPopular: true,
...
export function getSlipOptionById(formatType: string): SlipOptionConfig {
  ...
  return (
    found || {
      ...
      badgeColor: "bg-[#F5F7FA] text-[#0F2D5C] border border-[#E5E7EB]",
      price: 180,
      description: "Official NIN verification slip with barcode & QR code.",
      dimensions: "A4 / Letter (Portrait)",
