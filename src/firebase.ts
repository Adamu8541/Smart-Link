...
export async function testConnection() {
  try {
    ...
    // Gracefully handle initial offline/handshake states without polluting console with warnings
    if (process.env.NODE_ENV === "development") {
      console.debug("[Firebase] Initial connection check:", error instanceof Error ? error.message : error);
    }
  }
}
