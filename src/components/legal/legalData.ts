...
export const LEGAL_DOCUMENTS: LegalDocument[] = [
  ...
  // 12. REGULATORY COMPLIANCE FRAMEWORK
  {
    ...
    slug: "compliance",
    route: "/compliance",
    title: "SmartLink Nigeria Regulatory Compliance & Governance Framework",
    shortTitle: "Compliance Framework",
    category: "SECURITY_USE",
    categoryLabel: "Security & Compliance",
    summary:
      "Comprehensive disclosure of SmartLink Nigeria regulatory adherence, Nigeria Data Protection Act (NDPA 2023) alignment, Anti-Money Laundering (AML/CFT) frameworks, accredited corporate registry channels, and authorized telecommunications/fintech partnerships.",
    ...
    iconName: "ShieldCheck",
    highlights: [
      "Strict compliance with Nigeria Data Protection Act (NDPA 2023) and NDPR standards",
      "Tiered AML/CFT monitoring and SCUML Anti-Money Laundering filing alignment",
      "Partnership with CBN-licensed commercial banks and regulated payment switches",
      "Accredited corporate filings with Corporate Affairs Commission (CAC)",
    ],
    relatedDocIds: ["privacy-policy", "terms-of-service", "data-protection", "security"],
    sections: [
      {
        ...
        callout: {
          type: "notice",
          text: "SmartLink NG serves as an authorized technology facilitator and enterprise aggregator, connecting individuals, businesses, and developers directly to official regulatory rails.",
        },
      },
      {
        id: "data-privacy-compliance",
        title: "2. Data Protection & NDPA Compliance",
        content: [
          "Data privacy and lawful processing form the core pillars of our technical architecture. In accordance with the Nigeria Data Protection Act (NDPA 2023):",
          "• Lawful Basis: All identity lookups (NIN, BVN, CAC searches) are conducted exclusively on the basis of explicit data subject consent or legitimate contractual necessity.",
          "• Minimization & Purpose Limitation: We collect and process only the minimal metadata necessary to execute the requested verification, receipt generation, or bill payment.",
          "• Cryptographic Audit Trails: Every data processing request generates an immutable, tamper-evident audit record documenting timestamp, initiating IP address, user identifier, and specific operation type.",
          "• Designated Data Protection Officer (DPO): We maintain a dedicated compliance desk reachable at Smartlinkcomputerbusiness@gmail.com to handle user data access requests, rectification, and compliance queries.",
        ],
      },
      {
        id: "aml-cft-framework",
        title: "3. Anti-Money Laundering (AML/CFT) & Fraud Prevention",
        content: [
          "To combat financial crime and protect our ecosystem, SmartLink NG enforces automated real-time transaction monitoring and tiered KYC verification:",
          "• Tiered Verification: Access to high-volume wallet limits, developer API keys, and corporate registration services requires identity verification in accordance with regulatory thresholds.",
          "• Suspicious Activity Monitoring: Automated algorithms monitor transactions for unusual velocity patterns, structured payment attempts, or blacklisted account numbers. Suspicious activities are flagged immediately for administrative review.",
          "• Sanctions & PEP Screening: We enforce screening protocols against prohibited entity lists and support accredited SCUML (Special Control Unit Against Money Laundering) documentation workflows for Designated Non-Financial Businesses and Professions.",
        ],
      },
      {
        id: "audit-lawful-requests",
  ...
  // 13. SECURITY ARCHITECTURE & DATA INTEGRITY
  {
    id: "security",
    slug: "security",
    route: "/security",
    title: "SmartLink Nigeria Security & Data Protection Architecture",
    shortTitle: "Security Architecture",
    category: "SECURITY_USE",
    categoryLabel: "Security & Compliance",
    summary:
      "Details the comprehensive cybersecurity controls, TLS 1.3 encryption, AES-256 data protection at rest, dedicated virtual account safeguarding, role-based access controls, and vulnerability management protocols protecting the SmartLink platform.",
    version: "2.1.0 (Active)",
    effectiveDate: "March 10, 2024",
    lastUpdated: "September 01, 2026",
    readTime: "5 min read",
    iconName: "Lock",
    highlights: [
    ...
    sections: [
      {
        ...
        title: "1. Cryptographic Protection & Transmission Security",
        content: [
          "All data transmitted between your browser, mobile device, developer application, and the SmartLink servers is encrypted using modern Transport Layer Security (TLS 1.3 / TLS 1.2) with strict HSTS (HTTP Strict Transport Security) enforcement.",
          "Sensitive stored information—including transaction metadata, user preferences, API key hashes, and wallet reconciliation ledgers—is protected at rest using industry-standard Advanced Encryption Standard (AES-256) encryption.",
        ],
        callout: {
          type: "success",
          text: "SmartLink NG never stores raw user passwords or unmasked payment card CVV codes. All credentials use salted cryptographic hashing algorithms.",
        },
      },
      {
        id: "virtual-account-security",
        title: "2. Dedicated Virtual Account & Financial Vault Security",
        content: [
          "Your wallet funding accounts are provisioned directly with CBN-licensed, PCI-DSS Level 1 certified partner banks.",
          "Inbound transfers to virtual accounts trigger secure server-to-server webhook callbacks protected by cryptographic signature verification (HMAC-SHA512) to ensure funds are credited accurately with zero unauthorized tampering.",
          "Double-entry bookkeeping ledger architecture prevents negative balance exploits and ensures all wallet debits correspond to verified service dispatch receipts.",
        ],
      },
      {
        id: "access-controls",
        title: "3. Identity, Authentication & Session Security",
        content: [
          "SmartLink NG enforces granular Role-Based Access Control (RBAC) across customer, agent, enterprise, and administrative portals:",
          "• Secure Session Tokens: Sessions are secured with cryptographically generated tokens, automatic inactivity timeouts, and concurrent device tracking.",
          "• Brute-Force & Abuse Mitigation: Automated rate-limiters throttle anomalous authentication attempts, temporarily locking suspect accounts and alerting administrators.",
          "• Role Separation: Super Admin, Finance Auditor, Support Representative, and Regular User roles have strict isolation with least-privilege permissions.",
        ],
      },
      {
        id: "vulnerability-disclosure",
        title: "4. Vulnerability Management & Responsible Disclosure",
        content: [
          "We continuously audit our source code, dependencies, cloud container environments, and API endpoints for vulnerabilities.",
          "Security researchers and developers who identify potential vulnerabilities are encouraged to report findings responsibly to Smartlinkcomputerbusiness@gmail.com with detailed reproduction steps. We acknowledge valid reports within 24 hours and prioritize rapid remediation.",
        ],
      },
    ],
  },
  ...
  // 14. SERVICE LEVEL AGREEMENT (SLA)
  {
    ...
    slug: "sla",
    route: "/sla",
    title: "SmartLink Nigeria Service Level Agreement (SLA)",
    shortTitle: "Service Level Agreement (SLA)",
    category: "PAYMENTS_WALLET",
    categoryLabel: "Payments & Wallet",
    summary:
      "Defines the platform availability targets (99.9% target uptime), transaction completion speeds, developer API latency commitments, incident response timelines, and support escalation paths.",
    version: "1.3.0 (Active)",
    effectiveDate: "February 01, 2024",
    lastUpdated: "September 01, 2026",
    readTime: "5 min read",
    iconName: "Clock",
    highlights: [
      "99.9% Platform Core Uptime commitment across web portal and API endpoints",
      "Instant sub-10 second VTU and sub-30 second Electricity Disco token generation",
      "Sub-450ms p95 latency target for developer identity verification REST APIs",
      "Structured Tier 1 to Tier 3 support response matrix with 24/7 critical monitoring",
    ],
    relatedDocIds: ["terms-of-service", "refund-policy", "compliance", "security"],
    sections: [
      {
        id: "uptime-commitment",
        title: "1. Service Availability & Uptime Guarantee",
        content: [
          "SmartLink NG is engineered for high availability with geo-redundant cloud infrastructure, real-time load balancing, and failover capabilities.",
          "We commit to maintaining an operational Core Service Uptime of 99.9% during any calendar month, excluding scheduled maintenance windows announced at least twenty-four (24) hours in advance.",
          "Core Services include: Web and Mobile App access, Dedicated Virtual Account funding processing, Developer REST APIs, and Wallet Balance querying.",
        ],
        callout: {
          type: "notice",
      ...
      {
        id: "transaction-speed-sla",
        title: "2. Transaction Completion Speed Benchmarks",
        content: [
          "Under standard network conditions, SmartLink NG commits to the following transaction processing times:",
          "• Airtime & SME Data VTU: Instant dispatch delivered to telecom networks within 3 to 10 seconds.",
          "• Electricity Disco Meter Tokens: Token generated and receipt generated within 10 to 30 seconds.",
          "• Dedicated Virtual Account Funding: Automated ledger credit within 15 to 45 seconds of bank transfer clearance.",
          "• Identity Slip Generation (NIN/BVN): Digital PDF slip and plastic card layout generated within 5 to 15 seconds.",
          "• CAC Business Name Filings: Complete end-to-end filing review and submission to registry within 48 to 72 business hours.",
        ],
      },
      {
        id: "api-performance-sla",
        title: "3. Developer API Latency Targets",
        content: [
          "For enterprise integrators and software developers utilizing our RESTful API endpoints:",
          "• Average API Response Latency: Target p95 response time under 450 milliseconds for cached endpoints and sub-1.5 seconds for live third-party lookups.",
          "• Webhook Reliability: Automatic exponential backoff retry policy (up to 5 attempts) for failed merchant webhook endpoints.",
        ],
      },
      {
        id: "support-response-sla",
        title: "4. Customer Support Response Matrix",
        content: [
          "Our customer service and technical support desks operate structured response timelines based on issue severity:",
          "• Priority 1 (Critical Platform Outage / Wallet Funding Failure): Response within 1 hour; continuous escalation until resolution.",
          "• Priority 2 (Transaction Error / Pending Meter Token): Response within 2 to 4 hours with live provider escalation.",
          "• Priority 3 (General Inquiries, Legal, or Documentation Requests): Response within 12 to 24 hours.",
          "Official Support Channels: WhatsApp Support (+234 808 549 0982) and Official Email (Smartlinkcomputerbusiness@gmail.com).",
        ],
      },
    ],
  },
