    ...
    <section id="hero-section" className="relative overflow-hidden bg-white text-[#111827] py-10 sm:py-16 lg:pt-20 lg:pb-28 border-b border-[#E5E7EB]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="space-y-6 sm:space-y-8">
          ...
          <p
            id="hero-subheading"
            className="text-sm sm:text-base md:text-lg text-[#374151] font-normal leading-relaxed max-w-2xl mx-auto"
          >
          ...
          >
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-[#F8FAFC] border border-[#E2E8F0] shadow-2xs">
              ...
              <div>
                ...
                <p className="text-xs text-[#374151] mt-0.5">Zero-delay Disco tokens, cheap SME data bundles, airtime, and exam pins.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-[#F8FAFC] border border-[#E2E8F0] shadow-2xs">
              ...
              <div>
                ...
                <p className="text-xs text-[#374151] mt-0.5">Dedicated virtual account funding, encrypted payouts, and REST APIs.</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-xs text-[#374151] pt-2 flex items-center justify-center gap-1.5 flex-wrap">
