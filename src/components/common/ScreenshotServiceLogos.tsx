 ...
 */
export const WaecOfficialCardLogo: React.FC<{ className?: string }> = ({
  className = "w-10 h-10"
}) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
 ...
 */
export const NecoOfficialCardLogo: React.FC<{ className?: string }> = ({
  className = "w-10 h-10"
}) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Official Electricity Power Grid Logo
 */
export const ElectricityOfficialCardLogo: React.FC<{ className?: string }> = ({
  className = "w-10 h-10"
}) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Official Nigerian Passport Booklet Logo
 */
export const PassportOfficialCardLogo: React.FC<{ className?: string }> = ({
  className = "w-10 h-10"
}) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Official CBN Logo (Central Bank of Nigeria)
 */
export const CbnOfficialCardLogo: React.FC<{ className?: string }> = ({
  className = "w-10 h-10"
}) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
