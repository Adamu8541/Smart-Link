...
export default function AdminFooter() {
  return (
    <footer className="mt-auto border-t border-slate-800/80 bg-slate-950 py-4 px-4 md:px-8 text-[11px] text-slate-500 flex flex-col md:flex-row items-center justify-between gap-3">
