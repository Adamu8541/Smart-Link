        ...
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
            ...
            >
              ...
              {/* Filter Tabs */}
              <div className="p-3 border-b border-slate-800/80 bg-slate-950 flex items-center gap-1.5 overflow-x-auto text-xs">
                ...
                {unreadCount > 0 && (
                  <button
                    ...
                    className="ml-auto py-1 px-2.5 bg-slate-800 hover:bg-slate-700 text-blue-400 text-[10px] font-bold rounded-xl transition-colors cursor-pointer flex items-center gap-1 shrink-0"
                  >
                  ...
                  filtered.map((item) => (
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all space-y-2 ${
                        !item.read
                          ? "bg-slate-950 border-blue-500/40 shadow-sm"
