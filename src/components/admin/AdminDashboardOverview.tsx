...
import AdminModule1TestPanel from "./AdminModule1TestPanel";
...
export default function AdminDashboardOverview({
  ...
  const protectedRoutes = [
    ...
    { path: "/admin/providers", label: "API Gateway Providers", icon: Server, desc: "Monnify, OPay, VTU provider status", color: "from-teal-600/20 to-teal-900/10 border-teal-800/40" },
