...
const SAMPLE_JSON_TEMPLATES: Record<string, string> = {
  ...
  "Monnify Payment": JSON.stringify(
    {
      ...
      responseBody: {
        ...
        fee: "75.00",
        paymentReference: "MNFY|00|20260807|102030",
...
export default function ApiResponseMapperView({ session, onNavigate }: ApiResponseMapperViewProps) {
  ...
  const handleCreateNew = () => {
    setActiveMapping({
      provider: "Monnify",
      endpoint: "https://api.monnify.com/api/v1/disbursements/single",
      mappingName: "",
      ...
      status: "ENABLED",
      notes: "Default mapping template for Monnify payment responses."
    });
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="space-y-1.5 md:col-span-1">
                  ...
                  <input
                    ...
                    placeholder="e.g. Monnify, Paystack"
