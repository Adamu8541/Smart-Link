    ...
    >
      ...
      <div className="relative p-5 bg-white border-b-2 border-dashed border-black overflow-hidden min-h-[260px] flex flex-col justify-between">
        ...
        <div className="relative z-10 grid grid-cols-12 gap-3 items-center mt-2">
          ...
          <div className="col-span-4 relative">
            <div className="relative w-20 h-24 sm:w-24 sm:h-28 border border-slate-400 overflow-hidden bg-slate-50 shadow-xs">
              {photo && !imgError ? (
                <img
                  src={photo}
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-slate-100 text-slate-500 text-[9px] font-bold p-1 text-center">
                  <span>PHOTO</span>
                </div>
              )}
        ...
        {/* Bottom NIN Display */}
        <div className="relative z-10 mt-3 pt-2 text-center border-t border-slate-200">
          ...
          <p className="text-[8px] italic font-serif text-slate-700 mt-0.5">
      ...
      {isFoldable && (
        ...
        >
          ...
          <div className="relative z-10 pt-2 border-t border-slate-200 text-center flex items-center justify-between text-[8px] font-mono text-slate-500">
