...
export const NimcDigitalGreenSlip: React.FC<NimcDigitalGreenSlipProps> = ({
  ...
  return (
    <div
      id={id}
      className="bg-white text-slate-900 font-sans max-w-[420px] mx-auto border-2 border-black rounded-xl overflow-hidden shadow-xl select-text print:shadow-none print:border-2 print:border-black print:m-0 print:max-w-none print:w-[380px]"
      style={{ fontFamily: "'Arial', 'Segoe UI', sans-serif" }}
    >
      {/* =========================================================
          FRONT CARD (DIGITAL NIN SLIP)
          ========================================================= */}
      <div className="relative p-4 sm:p-5 bg-gradient-to-b from-emerald-50/90 via-emerald-100/40 to-emerald-50/90 border-b-2 border-dashed border-black overflow-hidden min-h-[255px]">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-20 flex flex-wrap gap-x-12 gap-y-8 p-3 select-none text-[11px] font-mono font-bold text-emerald-800 -rotate-12 transform scale-110">
        ...
        <div className="relative z-10 space-y-0.5">
          <h2 className="text-xs sm:text-[13px] font-black tracking-tight text-emerald-800 uppercase leading-none">
            FEDERAL REPUBLIC OF NIGERIA
          </h2>
          <h3 className="text-[11px] sm:text-xs font-black text-slate-900 tracking-wider uppercase">
            DIGITAL NIN SLIP
          </h3>
        </div>
        ...
        <div className="relative z-10 grid grid-cols-12 gap-2.5 mt-2.5 items-start">
          ...
          <div className="col-span-4 relative flex flex-col items-start">
            <div className="relative w-20 h-24 sm:w-24 sm:h-28 border-2 border-emerald-700/60 rounded-xs overflow-hidden bg-white shadow-xs">
              {photo && !imgError ? (
                <img
                  src={photo}
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-emerald-50 text-emerald-800 text-[9px] font-bold p-1 text-center">
                  <span>OFFICIAL</span>
                  <span>PHOTO</span>
                </div>
              )}
          ...
          <div className="col-span-5 space-y-1.5 text-[10px] sm:text-[11px] leading-tight">
            <div>
              <span className="text-[8.5px] font-bold text-slate-600 uppercase tracking-wider block">
                SURNAME/NOM
              </span>
              <span className="font-black text-slate-950 uppercase text-xs sm:text-[13px] block">
                {surname}
              </span>
            </div>
            ...
            <div>
              ...
              <span className="font-bold text-slate-950 uppercase block line-clamp-2">
                {givenNames}
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1 pt-0.5">
              <div>
                <span className="text-[8px] font-bold text-slate-600 uppercase block">DATE OF BIRTH</span>
                <span className="font-black text-slate-950 text-[10px] block font-mono">
                  {dob}
                </span>
              </div>
              <div>
                <span className="text-[8px] font-bold text-slate-600 uppercase block">SEX/SEXE</span>
                <span className="font-black text-slate-950 text-[10px] block">
                  {gender}
                </span>
              </div>
            </div>
          ...
          <div className="col-span-3 flex flex-col items-center justify-between h-full space-y-1">
            {qrDataUrl && (
              <div className="w-16 h-16 sm:w-18 sm:h-18 p-0.5 bg-white border border-slate-900 shadow-xs">
                <img src={qrDataUrl} alt="NIN 2D Verification Barcode" className="w-full h-full object-contain" />
              </div>
            )}
            <div className="text-center w-full">
              <span className="font-black text-xs tracking-wider text-slate-900 block leading-none">
                NGA
              </span>
              <span className="text-[7.5px] font-bold text-slate-600 uppercase block mt-0.5">
                ISSUE DATE
              </span>
              <span className="text-[8px] font-black text-slate-900 font-mono block">
                {formattedIssueDate}
              </span>
            </div>
          </div>
        ...
        <div className="relative z-10 mt-3 pt-1.5 border-t border-emerald-800/40 text-center">
          <span className="text-[9px] font-bold text-slate-800 uppercase tracking-wider block">
      ...
      {isFoldable && (
        ...
        >
          ...
          <div className="relative z-10 space-y-2 text-center">
            ...
            <p className="text-[10px] italic font-serif text-slate-700">
              Trust, but verify
            </p>
            ...
            <div className="space-y-1.5 text-[8.5px] sm:text-[9.5px] text-slate-900 leading-snug max-w-[340px] mx-auto text-center font-medium">
              <p>
          ...
          <div className="relative z-10 pt-2 border-t border-slate-300 text-center flex items-center justify-between text-[8px] font-mono text-slate-500">
