-- Migration 001: Initial Relational Foundation Schema
-- Smart Link NG Relational Database Architecture
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    account_number TEXT,
    bank_name TEXT,
    channel TEXT NOT NULL DEFAULT 'VIRTUAL_ACCOUNT' CHECK (channel IN ('VIRTUAL_ACCOUNT', 'CARD', 'TRANSFER', 'GATEWAY', 'MANUAL_ADMIN')),
